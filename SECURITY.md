...
We aim to keep `Medical-Adherence-Monitoring-System` up to date and secure. Please see below for the versions we currently support with security updates.
...
We value the contributions from the community and encourage responsible disclosure to help keep `Medical-Adherence-Monitoring-System` safe and secure for all users.
